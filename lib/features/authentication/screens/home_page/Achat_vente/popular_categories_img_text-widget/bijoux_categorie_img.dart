...
class BijouxCategorieImg extends StatelessWidget {
  const BijouxCategorieImg({super.key});

  @override
  Widget build(BuildContext context) {
    // Liste des images à afficher en utilisant TImages
    List<String> images = [
      TImages.montrehomme1,
      TImages.montrehomme2,
      TImages.colierblanc ,
      TImages.colierblanc2 ,
      TImages.colierblanc3,
      TImages.chainedoree,
      TImages.braceletdepierrep,
      TImages.bracelet1,
      TImages.bijouxdesoiree,
    ];
    ...
    return Scaffold(
      appBar: TAppBar(
        title: Text('Bijoux', style: TextStyle(fontSize: 20, color: Colors.black)),
        showBackArrow: true,
      ),
